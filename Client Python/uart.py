...
serial_mcu = serial.Serial('/dev/ttyAMA0', 115200, timeout=1)
debug_mcu = serial.Serial('/dev/ttyAMA1', 115200, timeout=1)

thread_alive = True

client = clientClass.UART_TCPClient("192.168.20.172", 9000, serial_mcu)
